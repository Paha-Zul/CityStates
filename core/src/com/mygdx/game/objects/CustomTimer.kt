...
/**
 * Creates a timer that is manually updated through the update() function. Can be used as a one shot (which needs to be
 * restarted) or a continuous tick timer.
 * @param secondsDelay The number of initial seconds to delay that start of the timer by
 * @param seconds The total runtime in seconds for the timer to run
 ...
 */
class CustomTimer(secondsDelay:Float, private var seconds: Float, var oneShot:Boolean = false, private var callback: (() -> Unit)? = null){

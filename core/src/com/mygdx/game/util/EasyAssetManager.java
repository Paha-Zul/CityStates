...
/**
 * A Wrapper class for LibGDX's AssetManager. This wrapper allows users to simply use a unique name to retrieve an asset.
 * For instance, if an image was loaded at 'assets/images/plants/some_plant.png' then the user can simply retrieve it with
 * manager.get('some_plant', Texture.class)
 */
        ...
        if(ref == null) {
            ...
            if(this.isLoaded(commonName)) {
                try {
                    ...
                    e.printStackTrace();
                    data = super.get(defaultImg, type);
                }
